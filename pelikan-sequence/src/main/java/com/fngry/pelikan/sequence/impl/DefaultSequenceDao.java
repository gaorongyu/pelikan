...
import com.fngry.pelikan.sequence.SequenceDao;
import com.fngry.pelikan.sequence.SequenceRange;
    ...
    private static void closeResultSet(ResultSet rs) {
        if (rs != null) {
            try {
                ...
                throw new SequenceException("Could not close JDBC ResultSet", e);
            } catch (Throwable e) {
                throw new SequenceException("Unexpected exception on closing JDBC ResultSet", e);
            }
        }
    }
    ...
    private static void closeStatement(Statement stmt) {
        if (stmt != null) {
            try {
                ...
                throw new SequenceException("Could not close JDBC Statement", e);
            } catch (Throwable e) {
                throw new SequenceException("Unexpected exception on closing JDBC Statement", e);
            }
        }
    }
    ...
    private static void closeConnection(Connection conn) {
        if (conn != null) {
            try {
                ...
                throw new SequenceException("Could not close JDBC Connection", e);
            } catch (Throwable e) {
                throw new SequenceException("Unexpected exception on closing JDBC Connection", e);
            }
        }
    }
